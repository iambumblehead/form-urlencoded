...
test('return encoded data', () => assert.strictEqual(
  formurlencoded({
    propStr1 : 'str1',
    propStr2 : 'str2'
  }, { sorted : true }),
...
test('return encoded data, with array properties', () => assert.strictEqual(
  formurlencoded({
    propStr1 : 'str1',
    propStr2 : 'str2',
...
test('return encoded data, with object properties', () => assert.strictEqual(
  formurlencoded({
    propStr1 : 'str1',
    propStr2 : 'str2',
    propObj1 : {
...
test('return encoded data, with mixed object array properties', () => {
  assert.strictEqual(
    formurlencoded({
      propStr1 : 'str1',
      propStr2 : 'str2',
...
test('properly encode all ascii characters', () => {
...
test('return encoded data, without null', () => assert.strictEqual(
  formurlencoded({
...
test('return encoded data, with empty arrays', () => assert.strictEqual(
  formurlencoded({
    propArr1 : [ 1, 2, 3 ],
    propArr2 : []
  }),
...
test('return encoded data, without empty arrays', () => assert.strictEqual(
  formurlencoded({
    propArr1 : [ 1, 2, 3 ],
    propArr2 : []
...
test('return encoded set', () => assert.strictEqual(
  formurlencoded({
    set : new Set([ 1, 'two' ])
  }),
  'set=1&set=two'
...
test('return encoded empty array', () => assert.strictEqual(
  formurlencoded({
    emptyArr : []
  }), 'emptyArr%5B%5D'
))

test('return encoded empty array inside an object', () => assert.strictEqual(
  formurlencoded({
    parent : {
      foo : 'bar',
      emptyArr : []
...
test('return encoded array inside an object with index', () => {
  assert.strictEqual(
    formurlencoded({
      parent : {
        foo : 'bar',
...
test('return encoded array inside an object without index', () => {
  assert.strictEqual(
    formurlencoded({
      parent : {
        foo : 'bar',
...
test('return array with index', () => assert.strictEqual(
  formurlencoded({
    key : [ 'val1' ]
  }),
  'key%5B0%5D=val1'
...
test('return array without index', () => assert.strictEqual(
  formurlencoded({
    key : [ 'val1' ]
  }, { skipIndex : true }),
  'key%5B%5D=val1'
...
test('return array name without brackets (when skipBracket is true)', () => {
  assert.strictEqual(
    formurlencoded({
      key : [ 'val1' ]
...
test('return nested object with "." as seperator', () => assert.strictEqual(
  formurlencoded({
    key : [ {
      val1 : 1,
      val2 : 2
...
test('return encoded urls with unicode characters', () => assert.strictEqual(
  formurlencoded({
    parent : {
      foo : '😀'
    }
...
test('return encoded urls with custom whitespace character', () => {
  assert.strictEqual(
    formurlencoded({
      parent : {
        foo : 'custom space'
